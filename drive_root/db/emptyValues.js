...
//
// Правило проекта (образец — классические учётные системы, см. ИНСТРУКЦИИ_ДЛЯ_AI.md, «Системность»):
...
// Пустая дата. Как в классических учётных системах: не NULL, а заведомо недостижимая ранняя дата,
