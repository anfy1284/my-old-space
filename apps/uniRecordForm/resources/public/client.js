...
try {
    (async function() {
        ...
        app.createInstance = async function(params) {
            ...
            function instanceOnOpen(tableName, recordID) {
                /*
                appForm.tableName = tableName || null;
                if (!tableName) {
            ...
            const instance = {
                ...
                async onOpen(params) {
                    ...
                    //openParams.tableName = openParams.tableName || '';
                    ...
                    try {
                        ...
                        console.error('[' + APP_NAME + '] failed to override DataForm loaders', e);
                    }
            ...
            if (params && (params.tableName || params.table)) instance.onOpen(params);
            return instance;
        };
